...
public class Memorama extends Stage implements EventHandler {
    ...
    private String[] arImagenes = {"c1.jpg", "c2.jpg", "c3.jpg", "c4.jpg", "c5.jpg", "c6.jpg", "c7.jpg", "c8.jpg", "c9.jpg", "c10.jpg"};
    ...
    public Memorama() {
        ...
        CrearUI();
        this.setTitle("Memorama Dragon ball Z");
        ...
        if(noPares <= 10 && noPares >= 2){
            ...
            for (int i = 0; i < 2; i++) {
                for (int j = 0; j < noPares; j++) {
                    ...
                    Image img = new Image("sample/assets/cb.jpg");
            ...
            alert.setTitle("");
            alert.setHeaderText("INVALIDO");
            alert.setContentText("Favor de ingresar un número de 2 a 10.");
            alert.showAndWait();
        }
    }
